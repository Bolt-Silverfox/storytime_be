...
const storyBuddiesData = [
  {
    ...
    personality: JSON.stringify({
      ...
      energy: 'high',
      style: 'playful',
      traits: ['curious', 'encouraging', 'patient'],
    }),
    voiceType: 'child-friendly',
    greetingMessages: [
      'Hello friend! Ready for an adventure?',
      'Hi there! Let\'s explore a story together!',
      'Hey! I\'m so excited to read with you today!',
      'Welcome back! What story should we discover?',
    ],
    ageGroupMin: 3,
    ageGroupMax: 12,
    isActive: true,
  },
  {
    ...
    personality: JSON.stringify({
      ...
      energy: 'medium',
      style: 'imaginative',
      traits: ['wise', 'calm', 'inspiring'],
    }),
    voiceType: 'gentle',
    greetingMessages: [
      'Greetings from the stars! Ready to explore?',
      'Hello, young explorer! Let\'s journey through stories!',
      'Welcome! The universe of stories awaits us!',
      'Hi! Let\'s discover something wonderful together!',
    ],
    ageGroupMin: 5,
    ageGroupMax: 12,
    isActive: true,
