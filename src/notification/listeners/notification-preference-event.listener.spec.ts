...
describe('NotificationPreferenceEventListener', () => {
    ...
    describe('handleUserRegistered', () => {
        ...
        it('should log an error if seedDefaultPreferences fails', async () => {
            ...
            mockNotificationPreferenceService.seedDefaultPreferences.mockRejectedValueOnce(error);
            ...
            expect(loggerSpy).toHaveBeenCalledWith(
                expect.stringContaining('Failed to seed notification preferences for user user-123: Seeding failed'),
            );
        });
    });
});
