...
export class SuccessResponse<T> {
  ...
  @ApiProperty({
    ...
    description: 'A short message describing the result.',
  })
  message?: string;
...
export class ErrorResponse {
  ...
  @ApiProperty({
    example: 'Bad Request',
    description: 'The error type or title.',
  })
  error: string;
  ...
  @ApiProperty({
    ...
    description:
      'A detailed message describing the error. Can be a string or an array of error strings.',
  })
