...
export interface IStoryRecommendationRepository {
    ...
    findParentRecommendationById(id: string): Promise<ParentRecommendation | null>;
...
export const STORY_RECOMMENDATION_REPOSITORY = Symbol('STORY_RECOMMENDATION_REPOSITORY');
